        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/AlexanderMatos01Dev" className="text-gray-400 hover:text-white transition duration-300">
                <Github className="w-6 h-6" />
              </a>
              <a href="https://www.linkedin.com/in/alexander-matos-028028314/" className="text-gray-400 hover:text-white transition duration-300">
